...
def progressive_caesar_encrypt(text):
    """
    Cifra solo la primera palabra del texto usando un método de cifrado César progresivo.
    
    En lugar de usar un desplazamiento fijo como en el cifrado César clásico, esta función aplica un desplazamiento que 
    incrementa con cada letra de la primera palabra del texto. La primera letra se desplaza 1 posición en el alfabeto, 
    la segunda se desplaza 2 posiciones, la tercera 3 posiciones, y así sucesivamente. El desplazamiento se reinicia en 
    el alfabeto cuando llega al final (cifrado modular). Solo se cifran los caracteres alfabéticos de la primera palabra.

    Args:
        text (str): El texto a cifrar.
        
    Returns:
        str: El texto con la primera palabra cifrada y el resto intacto.
    """
    words = text.split()
